Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/1amageek/NSMutableURLRequestMultipart.git", :tag => "0.1.2" }
  s.source_files  = ["NSMutableURLRequestMultipart/**/*.{h,m}"]
  s.exclude_files = ["NSMutableURLRequestMultipart/AppDelegate.*", "NSMutableURLRequestMultipart/main.m"]
